...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] branchString = new String[] { "CA","CS"};
	private String[] yearString = new String[] {"FY","SY","TY"};
	private String[] subjectFYString = new String[] {"SC","MC"};
	private String[] subjectSYString = new String[] {"GT","CN"};
	private String[] subjectTyString = new String[] {"DS","NS"};

	private String[] subjectFinal = new String[] {"DBMS","IoT","SE","JAVA","Python","VB"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		spinneryear.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View view,
				...
				else if(year.equalsIgnoreCase("sy"))
				{
					subjectFinal = subjectTEString;
				}
				else if(year.equalsIgnoreCase("ty"))
				{
